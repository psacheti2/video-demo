    ...
    <div className="flex items-center justify-center h-full p-6 mt-[-4rem]">
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-lg p-8 border border-gray-200 transition-all duration-300">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="rounded-xl border border-gray-300 px-4 py-3 bg-gray-50 hover:shadow-sm transition">
            <textarea
              ref={textareaRef}
              value={message}
          ...
          <div className="flex justify-between items-center">
            <label htmlFor="welcome-file-upload" className="cursor-pointer group">
              <div className="p-2 rounded-full border border-[#008080] hover:bg-[#00bfa6] transition-colors">
                <Upload className="w-5 h-5 text-[#008080] group-hover:text-white" />
              </div>
              <input
