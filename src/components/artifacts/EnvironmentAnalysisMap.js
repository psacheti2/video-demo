...
const EnvironmentMap = dynamic(
  () => import('./EnvironmentAnalysisMapComponent').then(module => ({ default: module.default })),
  {
    ssr: false,
...
function EnvironmentAnalysisMap(props) {
  ...
  return (
    <div className="w-full h-full">
      {isClient ? <EnvironmentMap {...updatedProps} /> : 
...
export default EnvironmentAnalysisMap;