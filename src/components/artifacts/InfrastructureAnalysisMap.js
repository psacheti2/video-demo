...
const AnalysisMap = dynamic(
  () => import('./InfrastructureAnalysisMapComponent').then(module => ({ default: module.default })),
  {
    ssr: false,
...
function InfrastructureAnalysisMap(props) {
  ...
  return (
    <div className="w-full h-full">
      {isClient ? <AnalysisMap {...updatedProps} /> : 
...
export default InfrastructureAnalysisMap;