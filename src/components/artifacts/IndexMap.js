...
const IndexMap = dynamic(
  () => import('./IndexMapComponent').then(module => ({ default: module.default })),
  {
    ssr: false,
...
function IndexAnalysisMap(props) {
  ...
  return (
    <div className="w-full h-full">
      {isClient ? <IndexMap {...updatedProps} /> : 
...
export default IndexAnalysisMap;